...
// MQTT: topics
const PROGMEM char* MQTT_SWITCH_STATUS_TOPIC1 = "sonoff/1/status";
const PROGMEM char* MQTT_SWITCH_COMMAND_TOPIC1 = "sonoff/1/switch";
// default payload
...
const PROGMEM uint8_t RELAY_PIN1= 12;
