/*
   ...
   Sources :
    ...
    you must also connect the dht11 sensor to d9 and then a 3v3 and gnd
...
sensor:
  - platform: mqtt
    state_topic: 'changeme/temp/both'
...
const PROGMEM char* MQTT_CLIENT_ID = "relaysdht";
...
// MQTT: topic for dht
const PROGMEM char* MQTT_SENSOR_TOPIC = "changeme/temp/both";
...
// sleeping time for dht
const PROGMEM uint16_t SLEEPING_TIME_IN_MILLISECONDS = 30000;
...
// Read temperature as Celsius (the default)
  ...
  // ESP.deepSleep(SLEEPING_TIME_IN_SECONDS * 1000000, WAKE_RF_DEFAULT);
    delay(1000);    //SLEEPING_TIME_IN_MILLISECONDS); // wait for deep sleep to happen (was 500)
}
